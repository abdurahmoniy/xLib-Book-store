...
const Card = ({ book }) => {
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-4 xl:grid-cols-5 grid-cols-2 text-center
       justify-between m-auto w-full my-10">
        {
          book.map((item) => {
            ...
            if (thumbnail != undefined && amount != undefined) {
              return (
                <>
                  <div className="w-[150px] mx-auto ss:w-[300px] border-myteal hover:scale-[1.05]
                   duration-300 border my-2 h-[250px] ss:h-auto ss:min-h-[300px] rounded-xl bg-myteal"
